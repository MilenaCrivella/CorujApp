        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    private void SendTitle(){
        final String mPath = "development.txt";
    ...
    private void MyListView(){
        ...
        List.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent SendText = new Intent(DevelopmentActivity.this, TextActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            startActivity(new Intent(DevelopmentActivity.this, MenuActivity.class));

        } else if (id == R.id.nav_family) {
            startActivity(new Intent(DevelopmentActivity.this, FamilyActivity.class));

        } else if (id == R.id.nav_health) {
            startActivity(new Intent(DevelopmentActivity.this, HealthActivity.class));

        } else if (id == R.id.nav_fun) {
            startActivity(new Intent(DevelopmentActivity.this, FunActivity.class));

        } else if (id == R.id.nav_vaccine) {
           startActivity(new Intent(DevelopmentActivity.this, VaccineActivity.class));

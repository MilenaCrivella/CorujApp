        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    private void MyListView(){
        ...
        List.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent SendText = new Intent(FunActivity.this, TextFunActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            startActivity(new Intent(FunActivity.this, MenuActivity.class));

        } else if (id == R.id.nav_family) {
            startActivity(new Intent(FunActivity.this, FamilyActivity.class));

        } else if (id == R.id.nav_health) {
            startActivity(new Intent(FunActivity.this, HealthActivity.class));

        } else if (id == R.id.nav_fun) {
            startActivity(new Intent(FunActivity.this, FunActivity.class));

        } else if (id == R.id.nav_vaccine) {
            startActivity(new Intent(FunActivity.this, VaccineActivity.class));
